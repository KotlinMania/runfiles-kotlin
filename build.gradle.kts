...
kotlin {
    ...
    val xcf = XCFramework("Runfiles")

    macosArm64 {
        binaries.framework { baseName = "Runfiles"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Runfiles"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "Runfiles"
        flattenPackage = "io.github.kotlinmania.runfiles"
    }

    android {
        namespace = "io.github.kotlinmania.runfiles"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "runfiles-kotlin", version.toString())

    pom {
        name.set("runfiles-kotlin")
        description.set("Kotlin Multiplatform port of bazelbuild/rules_rust - Runfiles lookup library for Bazel-built Rust binaries and tests")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/runfiles-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/runfiles-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/runfiles-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/runfiles-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleRunfilesXCFramework",
    "assembleRunfilesDebugXCFramework",
    "assembleRunfilesReleaseXCFramework",
    "assembleDebugIosFatFrameworkForRunfilesXCFramework",
    "assembleReleaseIosFatFrameworkForRunfilesXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForRunfilesXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForRunfilesXCFramework",
    "assembleDebugMacosFatFrameworkForRunfilesXCFramework",
    "assembleReleaseMacosFatFrameworkForRunfilesXCFramework",
    "assembleDebugTvosFatFrameworkForRunfilesXCFramework",
    "assembleReleaseTvosFatFrameworkForRunfilesXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForRunfilesXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForRunfilesXCFramework",
    "assembleDebugWatchosFatFrameworkForRunfilesXCFramework",
    "assembleReleaseWatchosFatFrameworkForRunfilesXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForRunfilesXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForRunfilesXCFramework",
