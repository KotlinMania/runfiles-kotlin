...
This file is the quick-reference operating contract for runfiles-kotlin. The longer
...
runfiles-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`runfiles`](https://crates.io/crates/runfiles). Upstream Rust is the behavioral oracle while the
